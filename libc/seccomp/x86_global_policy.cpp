...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 136, 57, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 74, 29, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 56, 91, 90), //ioctl|fcntl
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 58, 90, 89), //setpgid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 66, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 63, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 62, 87, 86), //umask|chroot
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 65, 86, 85), //dup2|getppid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 68, 85, 84), //setsid|sigaction
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 102, 13, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 90, 7, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 85, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 77, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 76, 80, 79), //sethostname|setrlimit
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 80, 79, 78), //getrusage|gettimeofday|settimeofday
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 87, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 86, 77, 76), //readlink
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 89, 76, 75), //swapon|reboot
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 96, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 94, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 93, 73, 72), //mmap|munmap|truncate
