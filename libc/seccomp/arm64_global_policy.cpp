...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 215, 15, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 218, 12, 11), //munmap|mremap|add_key
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 225, 11, 10), //keyctl|clone|execve|mmap|fadvise64|swapon
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 273, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 266, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 262, 5, 4), //wait4|prlimit64
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 272, 4, 3), //clock_adjtime|syncfs|setns|sendmmsg|process_vm_readv|process_vm_writev
