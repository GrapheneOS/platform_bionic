...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 79, 23, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 32, 11, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 24, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 13, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 12, 78, 77), //lseek|mmap|mprotect|munmap
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 21, 77, 76), //rt_sigaction|rt_sigprocmask|rt_sigreturn|ioctl|pread64|pwrite64|readv|writev
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 29, 76, 75), //sched_yield|mremap|msync|mincore|madvise
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 37, 71, 70), //nanosleep|getitimer
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 43, 70, 69), //setitimer|getpid|sendfile|socket|connect
