...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 13, 7, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 12, 93, 92), //lseek|mmap|mprotect|munmap
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 32, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 24, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 21, 90, 89), //rt_sigaction|rt_sigprocmask|rt_sigreturn|ioctl|pread64|pwrite64|readv|writev
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 29, 89, 88), //sched_yield|mremap|msync|mincore|madvise
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 33, 88, 87), //dup
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 43, 83, 82), //setitimer|getpid|sendfile|socket|connect
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 57, 82, 81), //sendto|recvfrom|sendmsg|recvmsg|shutdown|bind|listen|getsockname|getpeername|socketpair|setsockopt|getsockopt|clone
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 78, 78, 77), //fcntl|flock|fsync|fdatasync|truncate|ftruncate
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 82, 77, 76), //getcwd|chdir|fchdir
