...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 217, 12, 11), //munmap|mremap
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 224, 11, 10), //clone|execve|mmap|fadvise64
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 274, 3, 0),
